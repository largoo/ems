...
CREATE TABLE `equip` (
  ...
  `manu` varchar(1000) DEFAULT NULL COMMENT '制造商名称',
  `model` varchar(1000) DEFAULT NULL COMMENT '型号',
  `assetno` varchar(1000) DEFAULT NULL COMMENT '固定资产编号',
  `opendate` varchar(100) DEFAULT NULL COMMENT '开箱日期',
  `openfilename` varchar(1000) DEFAULT NULL COMMENT '开箱文档',
  `openfilesavename` varchar(1000) DEFAULT NULL COMMENT '开箱文档真实文件名',
  `openfilepath` varchar(1000) DEFAULT NULL COMMENT '开箱文档路径',
  ...
  `hookupfilename` varchar(1000) DEFAULT NULL COMMENT '设备二次配附表',
  `hookupfilesavename` varchar(1000) DEFAULT NULL COMMENT '设备二次配附表真实文件名',
  `hookupfilepath` varchar(1000) DEFAULT NULL COMMENT '设备二次配附表路径',
  `powerondate` varchar(100) DEFAULT NULL COMMENT '上电日期',
  `togy` varchar(100) DEFAULT NULL COMMENT '交付工艺日期',
  `togyfilename` varchar(1000) DEFAULT NULL COMMENT '交付工艺附档文件名',
  `togyfilesavename` varchar(1000) DEFAULT NULL COMMENT '交付工艺附档文件真实名',
  `togyfilepath` varchar(1000) DEFAULT NULL COMMENT '交付工艺附档文件路径',
  `toproductdate` varchar(100) DEFAULT NULL COMMENT '交付生产',
  `fatdate` varchar(100) DEFAULT NULL COMMENT 'FAT日期',
  `fatfilename` varchar(1000) DEFAULT NULL COMMENT 'FAT文档名',
  `fatfilesavename` varchar(1000) DEFAULT NULL COMMENT 'FAT文档真实文件名',
  `fatfilepath` varchar(1000) DEFAULT NULL COMMENT 'FAT文件路径',
  ...
  `assetdate` varchar(100) DEFAULT NULL,
  `assetfilename` varchar(1000) DEFAULT NULL,
  `assetfilesavename` varchar(1000) DEFAULT NULL,
  `assetfilepath` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`eid`),
...
INSERT INTO `orders` VALUES (1,'ZG-YX-108-层压机#3','2017-07-15 16:55:32',2,'层压机加热站电机轴承磨损异响，更换电机轴承。','更换电机轴承','2017-07-15 16:56:59','轴承','',6,6,1,1,0),(2,'ZG-YX-108-串焊机#1-ASYS(LOADER,SCRIBE,PRINTER)','2017-07-24 09:35:13',2,'111','','2017-08-17 14:53:34','','',8,1,1,1,0),(3,'1','2017-09-11 16:21:04',2,'1','','2017-09-11 16:31:03','','',10,10,1,1,0),(4,'1','2017-09-11 16:36:00',1,'',NULL,NULL,NULL,NULL,10,NULL,0,0,0);
...
-- Dump completed on 2017-09-12 13:42:43
